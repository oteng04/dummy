                        ...
                        <?php if (in_array('doctor', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    <a href="doctor">
                                    <?php } ?>
                                    <section class="panel home_sec_green" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                        <div  style="background: #F38630;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                        ...
                        <?php if (in_array('patient', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    <a href="patient">
                                    <?php } ?>
                                    <section class="panel home_sec_blue" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                       <div  style="background: #5d576b;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                        ...
                        <?php if (in_array('appointment', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    <a href="appointment">
                                    <?php } ?>
                                    <section class="panel home_sec_yellow" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                      <div  style="background: #736ced;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-plus-square-o" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                        ...
                        <?php if (in_array('prescription', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <?php } ?>
                                    <section class="panel home_sec_green" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                           <div  style="background: #232e21;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-file-text" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                        ...
                        <?php if (in_array('patient', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <?php } ?>
                                    <section class="panel home_sec_blue" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                          <div  style="background: #29335c;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-calendar-o" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                        ...
                        <?php if (in_array('lab', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <?php } ?>
                                    <section class="panel home_sec_green" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                           <div  style="background: #bfae48;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-medkit" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                        ...
                        <?php if (in_array('patient', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <?php } ?>
                                    <section class="panel home_sec_blue" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                     <div  style="background: #f42272;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-file" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
                        ...
                        <?php if (in_array('finance', $this->modules)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <?php } ?>
                                    <section class="panel home_sec_yellow" style="border-radius: 12px 0px 0px 12px;   -webkit-border-radius: 12px 0px 0px 12px;">
                                      <div  style="background: #66ced6;  width: 40%;
                                     padding: 25px 15px;
                                    -webkit-border-radius: 12px;
                                    border-radius: 12px; display: inline-block;
                                     text-align: center;margin-top:-8px;margin-bottom: 8px;margin-left: -8px;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
                                           
                                            <i class="fa fa-money" style="font-size: 50px;color:#fff"></i>
                                        </div>
                                        <div class="value">
                                            <h3 class="">
                                                <?php
