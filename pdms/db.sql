...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2022 at 07:29 PM
...
(416, 'STU Clinic', 'koranteng.admin@stuclinic.com', '', 'Sunyani, Ghana', '+233  557 189 027', '', '1000', '500', 'accountant,appointment,lab,bed,department,doctor,donor,finance,pharmacy,laboratorist,medicine,nurse,patient,pharmacist,prescription,receptionist,report,notice,email,sms', '2');
...
(3, 'Hospital management System', 'Hospital', 'Colegepara, Rajbari', '+0123456789', 'admin@hms.com', '', 'GH₵', 'english', 'flat', '', '', '', '', 'PayPal', '', '', '', '416'),
...
(1, '127.0.0.1', 'superadmin', '$2y$08$1Rvlfb8r7JXT9SZtzbGYGuttL1p7G4ULzMtOOb4YkxCHuU383eEGK', '', 'superadmin@hms.com', '', 'eX0.Bq6nP57EuXX4hJkPHO973e7a4c25f1849d3a', 1511432365, 'zCeJpcj78CKqJ4sVxVbxcO', 1268889823, 1654103059, 1, 'Super', 'Admin', 'ADMIN', '0', ''),
(2, '127.0.0.1', 'STU Clinic', '$2y$08$nxWYs4Sc9VN6czyUtnJRwuMaflhMRZSV33GESf5zi8rjXGfaSHVlu', NULL, 'koranteng.admin@stuclinic.com', NULL, NULL, NULL, NULL, 1268889832, 1654104363, 1, 'admin', NULL, NULL, NULL, '');
